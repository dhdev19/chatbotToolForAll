...
(function () {
  ...
  fetch(`https://chatbot.dhgenixmedia.ae/chatbot/embed?project_id=${projectId}&user_id=${userId}`)
    .then(response => {
    ...
    .then(html => {
      ...
      // Dispatch custom event after embed is ready
      setTimeout(() => {
        const event = new Event("ChatbotEmbedReady");
