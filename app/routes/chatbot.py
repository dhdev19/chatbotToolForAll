...
def embed_chatbot():
    ...
    project = project_list[0]
    bot_name = User.get_bot_name(user_id)
    return render_template('embed_code.html', project=project, bot_name = bot_name, chatbot_api_url=chatbot_api_url)
...
def add_project():
    ...
    # New projects are approved by default
    project = Projects(
        user_id=session['user_id'],
...
def chatbot_endpoint():
    ...
    try:
        ...
        prompt = f"""Your name is Alvi, you are a chatbot assistant. Keep your tone friendly and professional. If the user greets or says hi, greet him.Answer questions based on the following data and make sure to limit your response to the data provided and under 15 words.If you are not sure about the answer, pass the contact information and say "I'm sorry, I don't have information about that. Please contact us directly for more information":
